...
export interface Adapter {
  ...
  parseMangaData: (mangaName: string, body: string | Buffer) => Manga | null,
  parsePageLinks: (url: string, body: string) => string[],
  parsePageImage: (body: string | Buffer) => string | null,
}