...
export function chapterPath(basePath: string, mangaName: string, chapterNum: number): string {
  return path.join(mangaPath(basePath, mangaName), String(chapterNum))
}

export function imagePath(basePath: string, mangaName: string, chapterNum: number, url: string): string {
